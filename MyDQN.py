...
class DQN:
        ...
        def replay(self, BATCH_SIZE):
            ...
            next_state_values = self.model(next_states_batch).max(1)[0]
...
class Gym_model:
    ...
    def run(self):
        ...
        try:
            ...
            #np.savetxt('data/DQN1loss_list.csv', loss_list, delimiter=',')
            #np.savetxt('data/DQN1reward_list.csv', reward_list, delimiter=',')
           # np.savetxt('data/DQN1times_list.csv', times_list, delimiter=',')
...
if __name__ == "__main__":
    ...
    #model = "data/MountainCar_DQN.model"
    #model_name = 'CartPole-v0'
    #model = "data/CartPole_DQN.model"
    model_name = 'Acrobot-v1'
    model = "data/Acrobot_DQN.model"
